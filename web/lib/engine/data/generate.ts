...
import { CityConfig, DATA_SEED, DEFAULT_CORRIDORS } from "@/lib/engine/config";
import { loadRealData, loadRealWards, type RealLandProps } from "@/lib/engine/data/real";
import { makeWardLocator } from "@/lib/engine/gis/population";
import {
  mulberry32,
  Rng,
  randRange,
